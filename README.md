...
You're on a project to help modernize the website for the Children, Youth and Families Department (CYFD) for the State of New Mexico.

The CYFD has a prototype of an online form to help parents determine their eligibility for benefits, and to tell them which form they need to fill out.

Currently, the online form checks if parents are eligible and how much coverage they'll receive for Child Day Care Benefits (Form B202) and Extended Care (Form D303).
